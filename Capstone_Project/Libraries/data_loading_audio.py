...
Original file is located at
    https://colab.research.google.com/drive/1sUD1Aruzj6iklhZmf9jSwE5Z2YATYN4Y
"""
...
#%% Min Max Normalizer
def ReverseMinMaxScaler(data, dataMin, dataMax):
...
def audio_data_loading (seq_length):

    # Load Google Data
    x = np.loadtxt('data/AUDIO_DATA.csv', delimiter = ",",skiprows = 1, usecols=range(1,5))
    # Flip the data to make chronological data
    x = x[::-1]
    # Min-Max Normalizer
    x = MinMaxScaler(x)
